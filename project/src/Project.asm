...
vpat	BYTE	0	; V 0 NNNNNN (visible, 5B type=off, pattern number 0..63)
	...
	MACRO LOADSPRITE spriteDataAddr
	ld	hl, spriteDataAddr
...
_Setup:
	...
	nextreg SPRITE_TRANSPARENCY_I_NR_4B, $10
...
UploadSprites:
	...
	xor	a	; easy way to zero the accumulator
			; vary this to determine which slot to start loading from
	...
	;LOADSPRITE Sprite1_1
	LOADSPRITE Sprite1
	LOADSPRITE Sprite1_2
	LOADSPRITE Sprite1_3

	; LOADSPRITE SpritePixelData
	; LOADSPRITE SpritePixelData+256
	; LOADSPRITE SpritePixelData+256+256
...
Player1MoveByControls:
		...
		bit	JOY_BIT_RIGHT,b
		jr	z,.notGoingRight
		ld	(ix+S_SPRITE_4B_ATTR.vpat),$80+0 ; default right sprite
		inc	hl
		inc	hl	; X += 2
...
.notGoingDown:
		...
		; LOADSPRITE Sprite1_17
		; LOADSPRITE Sprite1_18
		; LOADSPRITE Sprite1_19
		ret
